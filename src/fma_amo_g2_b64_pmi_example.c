...
/*
 * FMA AMO second generation 64 bit test example - this test only uses PMI
 *
...
"    second generation 64 bit request.\n"
"\n"
"  APIs:\n"
...
"      - fma_amo_g2_b64_pmi_example -e\n"
"      - fma_amo_g2_b64_pmi_example -f\n"
"      - fma_amo_g2_b64_pmi_example -f -C\n"
"      - fma_amo_g2_b64_pmi_example -f -e\n"
"      - fma_amo_g2_b64_pmi_example -a\n"
"      - fma_amo_g2_b64_pmi_example -a -C\n"
"      - fma_amo_g2_b64_pmi_example -a -e\n"
"      - fma_amo_g2_b64_pmi_example -a -f\n"
"      - fma_amo_g2_b64_pmi_example -a -f -C\n"
"      - fma_amo_g2_b64_pmi_example -a -f -e\n"
"      - fma_amo_g2_b64_pmi_example -c\n"
"      - fma_amo_g2_b64_pmi_example -c -C\n"
"      - fma_amo_g2_b64_pmi_example -c -e\n"
"      - fma_amo_g2_b64_pmi_example -c -I\n"
"      - fma_amo_g2_b64_pmi_example -c -f\n"
"      - fma_amo_g2_b64_pmi_example -c -f -C\n"
"      - fma_amo_g2_b64_pmi_example -c -f -e\n"
"      - fma_amo_g2_b64_pmi_example -c -f -I\n"
"      - fma_amo_g2_b64_pmi_example -m\n"
"      - fma_amo_g2_b64_pmi_example -m -C\n"
"      - fma_amo_g2_b64_pmi_example -m -I\n"
"      - fma_amo_g2_b64_pmi_example -m -f\n"
"      - fma_amo_g2_b64_pmi_example -m -f -C\n"
"      - fma_amo_g2_b64_pmi_example -m -f -I\n"
"      - fma_amo_g2_b64_pmi_example -M\n"
"      - fma_amo_g2_b64_pmi_example -M -C\n"
"      - fma_amo_g2_b64_pmi_example -M -I\n"
"      - fma_amo_g2_b64_pmi_example -M -f\n"
"      - fma_amo_g2_b64_pmi_example -M -f -C\n"
"      - fma_amo_g2_b64_pmi_example -M -f -I\n"
"      - fma_amo_g2_b64_pmi_example -o\n"
"      - fma_amo_g2_b64_pmi_example -o -C\n"
"      - fma_amo_g2_b64_pmi_example -o -e\n"
"      - fma_amo_g2_b64_pmi_example -o -f\n"
"      - fma_amo_g2_b64_pmi_example -o -f -C\n"
"      - fma_amo_g2_b64_pmi_example -o -f -e\n"
"      - fma_amo_g2_b64_pmi_example -s\n"
"      - fma_amo_g2_b64_pmi_example -s -C\n"
"      - fma_amo_g2_b64_pmi_example -s -e\n"
"      - fma_amo_g2_b64_pmi_example -s -f\n"
"      - fma_amo_g2_b64_pmi_example -s -f -C\n"
"      - fma_amo_g2_b64_pmi_example -s -f -e\n"
"      - fma_amo_g2_b64_pmi_example -x\n"
"      - fma_amo_g2_b64_pmi_example -x -C\n"
"      - fma_amo_g2_b64_pmi_example -x -e\n"
"      - fma_amo_g2_b64_pmi_example -x -f\n"
"      - fma_amo_g2_b64_pmi_example -x -f -C\n"
"      - fma_amo_g2_b64_pmi_example -x -f -e\n"
"      - fma_amo_g2_b64_pmi_example -X\n"
"      - fma_amo_g2_b64_pmi_example -X -C\n"
"      - fma_amo_g2_b64_pmi_example -X -e\n"
"      - fma_amo_g2_b64_pmi_example -X -f\n"
...
{
    gni_fma_cmd_type_t amo_command = GNI_FMA_ATOMIC2_AND;
    ...
    int             i;
    uint64_t        invalid_compare_value = 0;
    ...
    uint64_t        reverse_min_max_value = 0;
    int             send_to;
    int             shift_count;
    ...
    while ((opt = getopt(argc, argv, "ab:cCefhImMn:osvxX")) != -1) {
        switch (opt) {
        case 'a':
            amo_command = GNI_FMA_ATOMIC2_IADD;
        ...
        case 'c':
            amo_command = GNI_FMA_ATOMIC2_CSWAP;
            transfer_length = 2;
        ...
        case 'm':
            amo_command = GNI_FMA_ATOMIC2_IMIN;

            break;

        case 'M':
            amo_command = GNI_FMA_ATOMIC2_IMAX;
        ...
        case 'o':
            amo_command = GNI_FMA_ATOMIC2_OR;

            break;

        case 's':
            amo_command = GNI_FMA_ATOMIC2_SWAP;
        ...
        case 'x':
            amo_command = GNI_FMA_ATOMIC2_XOR;

            break;

        case 'X':
            amo_command = GNI_FMA_ATOMIC2_AX;
            transfer_length = 2;
            byte_alignment = BYTE_ALIGNMENT * transfer_length;
    ...
    if (use_fetch == 1) {
        switch (amo_command) {
        case GNI_FMA_ATOMIC2_AND:
            amo_command = GNI_FMA_ATOMIC2_FAND;
            break;
        case GNI_FMA_ATOMIC2_AX:
            amo_command = GNI_FMA_ATOMIC2_FAX;
            transfer_length = 1;
            byte_alignment = BYTE_ALIGNMENT;
            break;
        case GNI_FMA_ATOMIC2_CSWAP:
            amo_command = GNI_FMA_ATOMIC2_FCSWAP;
            transfer_length = 1;
            byte_alignment = BYTE_ALIGNMENT;
            break;
        case GNI_FMA_ATOMIC2_IADD:
            amo_command = GNI_FMA_ATOMIC2_FIADD;
            break;
        case GNI_FMA_ATOMIC2_IMAX:
            amo_command = GNI_FMA_ATOMIC2_FIMAX;
            break;
        case GNI_FMA_ATOMIC2_IMIN:
            amo_command = GNI_FMA_ATOMIC2_FIMIN;
            break;
        case GNI_FMA_ATOMIC2_OR:
            amo_command = GNI_FMA_ATOMIC2_FOR;
            break;
        case GNI_FMA_ATOMIC2_SWAP:
            amo_command = GNI_FMA_ATOMIC2_FSWAP;
            break;
        case GNI_FMA_ATOMIC2_XOR:
            amo_command = GNI_FMA_ATOMIC2_FXOR;
            break;
        default:
            break;
        }
    ...
    if (use_cache_request == 1) {
        ...
        switch (amo_command) {
        case GNI_FMA_ATOMIC2_AND:
            amo_command = GNI_FMA_ATOMIC2_AND_C;
            break;
        case GNI_FMA_ATOMIC2_FAND:
            amo_command = GNI_FMA_ATOMIC2_FAND_C;
            break;
        case GNI_FMA_ATOMIC2_AX:
            amo_command = GNI_FMA_ATOMIC2_AX_C;
            break;
        case GNI_FMA_ATOMIC2_FAX:
            amo_command = GNI_FMA_ATOMIC2_FAX_C;
            break;
        case GNI_FMA_ATOMIC2_CSWAP:
            amo_command = GNI_FMA_ATOMIC2_CSWAP_C;
            break;
        case GNI_FMA_ATOMIC2_FCSWAP:
            amo_command = GNI_FMA_ATOMIC2_FCSWAP_C;
            break;
        case GNI_FMA_ATOMIC2_IADD:
            amo_command = GNI_FMA_ATOMIC2_IADD_C;
            break;
        case GNI_FMA_ATOMIC2_FIADD:
            amo_command = GNI_FMA_ATOMIC2_FIADD_C;
            break;
        case GNI_FMA_ATOMIC2_IMAX:
            amo_command = GNI_FMA_ATOMIC2_IMAX_C;
            break;
        case GNI_FMA_ATOMIC2_FIMAX:
            amo_command = GNI_FMA_ATOMIC2_FIMAX_C;
            break;
        case GNI_FMA_ATOMIC2_IMIN:
            amo_command = GNI_FMA_ATOMIC2_IMIN_C;
            break;
        case GNI_FMA_ATOMIC2_FIMIN:
            amo_command = GNI_FMA_ATOMIC2_FIMIN_C;
            break;
        case GNI_FMA_ATOMIC2_OR:
            amo_command = GNI_FMA_ATOMIC2_OR_C;
            break;
        case GNI_FMA_ATOMIC2_FOR:
            amo_command = GNI_FMA_ATOMIC2_FOR_C;
            break;
        case GNI_FMA_ATOMIC2_SWAP:
            amo_command = GNI_FMA_ATOMIC2_SWAP_C;
            break;
        case GNI_FMA_ATOMIC2_FSWAP:
            amo_command = GNI_FMA_ATOMIC2_FSWAP_C;
            break;
        case GNI_FMA_ATOMIC2_XOR:
            amo_command = GNI_FMA_ATOMIC2_XOR_C;
            break;
        case GNI_FMA_ATOMIC2_FXOR:
            amo_command = GNI_FMA_ATOMIC2_FXOR_C;
            break;
        default:
            break;
        }
    ...
    transfer_length_in_bytes = sizeof(uint64_t) * transfer_length * buffer_size;
    ...
    switch (amo_command) {
    case GNI_FMA_ATOMIC2_AND:
    case GNI_FMA_ATOMIC2_AND_C:
    case GNI_FMA_ATOMIC2_FAND:
    case GNI_FMA_ATOMIC2_FAND_C:
    case GNI_FMA_ATOMIC2_AX:
    case GNI_FMA_ATOMIC2_AX_C:
    case GNI_FMA_ATOMIC2_FAX:
    case GNI_FMA_ATOMIC2_FAX_C:
        source_init_value = (uint64_t) (my_rank | ALL_ONES_DATA);
        target_init_value = (uint64_t) (my_rank | DEFAULT_DATA);
        break;
    case GNI_FMA_ATOMIC2_CSWAP:
    case GNI_FMA_ATOMIC2_CSWAP_C:
    case GNI_FMA_ATOMIC2_FCSWAP:
    case GNI_FMA_ATOMIC2_FCSWAP_C:
    case GNI_FMA_ATOMIC2_OR:
    case GNI_FMA_ATOMIC2_OR_C:
    case GNI_FMA_ATOMIC2_FOR:
    case GNI_FMA_ATOMIC2_FOR_C:
    case GNI_FMA_ATOMIC2_SWAP:
    case GNI_FMA_ATOMIC2_SWAP_C:
    case GNI_FMA_ATOMIC2_FSWAP:
    case GNI_FMA_ATOMIC2_FSWAP_C:
    case GNI_FMA_ATOMIC2_XOR:
    case GNI_FMA_ATOMIC2_XOR_C:
    case GNI_FMA_ATOMIC2_FXOR:
    case GNI_FMA_ATOMIC2_FXOR_C:
        source_init_value = (uint64_t) (my_rank | ALL_ZEROS_DATA);
        target_init_value = (uint64_t) (my_rank | DEFAULT_DATA);
        break;
    case GNI_FMA_ATOMIC2_IADD:
    case GNI_FMA_ATOMIC2_IADD_C:
    case GNI_FMA_ATOMIC2_FIADD:
    case GNI_FMA_ATOMIC2_FIADD_C:
        source_init_value = (uint64_t) (my_rank | ALL_ZEROS_DATA);
        target_init_value = (uint64_t) (my_rank | ALL_ZEROS_DATA);
        break;
    case GNI_FMA_ATOMIC2_IMAX:
    case GNI_FMA_ATOMIC2_IMAX_C:
    case GNI_FMA_ATOMIC2_FIMAX:
    case GNI_FMA_ATOMIC2_FIMAX_C:
    case GNI_FMA_ATOMIC2_IMIN:
    case GNI_FMA_ATOMIC2_IMIN_C:
    case GNI_FMA_ATOMIC2_FIMIN:
    case GNI_FMA_ATOMIC2_FIMIN_C:
        source_init_value = (uint64_t) (my_rank | ALL_ZEROS_DATA |
    ...
    for (i = 0; i < transfers; i++) {
        if ((amo_command == GNI_FMA_ATOMIC2_CSWAP) ||
            (amo_command == GNI_FMA_ATOMIC2_CSWAP_C) ||
            (amo_command == GNI_FMA_ATOMIC2_FCSWAP) ||
            (amo_command == GNI_FMA_ATOMIC2_FCSWAP_C) ||
            (amo_command == GNI_FMA_ATOMIC2_SWAP) ||
    ...
    for (i = 0; i < transfers; i++) {
        ...
        if ((amo_command != GNI_FMA_ATOMIC2_IADD) &&
                   (amo_command != GNI_FMA_ATOMIC2_IADD_C) &&
                   (amo_command != GNI_FMA_ATOMIC2_FIADD) &&
                   (amo_command != GNI_FMA_ATOMIC2_FIADD_C)) {
    ...
    for (i = 0; i < transfers; i++) {
        ...
        case GNI_FMA_ATOMIC2_FCSWAP_C:
            if (do_invalid_compare == 0) {
                ...
                shift_count = ((rank_id * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO;
                expected_data = (uint64_t) (my_rank |
                    ((uint64_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                    ((uint64_t) 1 << shift_count));
            }
            break;
        ...
        case GNI_FMA_ATOMIC2_FIMIN_C:
            if (do_invalid_compare == 0) {
                shift_count = ((rank_id * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO;
                expected_data = (my_rank | ((uint64_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                    ALL_ZEROS_DATA);
            } else {
                shift_count = ((receive_from * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO;
                expected_data = (my_rank | ((uint64_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
    ...
    for (i = 0; i < transfers; i++) {
        ...
        case GNI_FMA_ATOMIC2_CSWAP_C:
            expected_data = (uint64_t) (my_rank |
                ((uint64_t) (i + 1) << TRANSFER_COUNT_SHIFT) | DEFAULT_DATA);
            break;
        case GNI_FMA_ATOMIC2_FCSWAP:
        case GNI_FMA_ATOMIC2_FCSWAP_C:
        ...
        case GNI_FMA_ATOMIC2_FIMAX:
        case GNI_FMA_ATOMIC2_FIMAX_C:
            expected_data = (my_send_to | ((uint64_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                ALL_ZEROS_DATA | reverse_min_max_value);
            break;
        case GNI_FMA_ATOMIC2_IMIN:
        case GNI_FMA_ATOMIC2_IMIN_C:
