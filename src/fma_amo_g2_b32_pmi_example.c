...
/*
 * FMA AMO second generation 32 bit test example - this test only uses PMI
 *
...
"    second generation 32 bit request.\n"
"\n"
"  APIs:\n"
...
"      2.  '-b' specifies the size of the data buffer.\n"
"      3.  '-c' use the COMPARE and SWAP AMO command.\n"
"      4.  '-C' use the CACHE variant of the AMO command.\n"
"      5.  '-e' specifies that the GNI_EpSetEventId API will be used.\n"
"      6.  '-f' use a fetching AMO command.\n"
"      7.  '-h' prints the help information for this example.\n"
"      8.  '-I' use an invalid compare operand for the COMPARE and SWAP AMO\n"
"          command or for IMAX or IMIN reverse the comparision values.\n"
"      9.  '-m' use the IMIN AMO command.\n"
"     10.  '-M' use the IMAX AMO command.\n"
"     11.  '-n' specifies the number of data transactions that will be sent.\n"
"          The default value is 440 data transactions to be sent.\n"
"     12.  '-o' use the OR AMO command.\n"
"     13.  '-s' use the SWAP AMO command.\n"
"     14.  '-v', '-vv' or '-vvv' allows various levels of output or debug\n"
"          messages to be displayed.  With each additional 'v' more\n"
"          information will be displayed.\n"
"          The default value is no output or debug messages will be\n"
"          displayed.\n"
"     15.  '-x' use the XOR AMO command.\n"
"     16.  '-X' use the AX AMO command.\n"
"\n"
"  Execution:\n"
...
"      - fma_amo_g2_b32_pmi_example -e\n"
"      - fma_amo_g2_b32_pmi_example -f\n"
"      - fma_amo_g2_b32_pmi_example -f -C\n"
"      - fma_amo_g2_b32_pmi_example -f -e\n"
"      - fma_amo_g2_b32_pmi_example -a\n"
"      - fma_amo_g2_b32_pmi_example -a -C\n"
"      - fma_amo_g2_b32_pmi_example -a -e\n"
"      - fma_amo_g2_b32_pmi_example -a -f\n"
"      - fma_amo_g2_b32_pmi_example -a -f -C\n"
"      - fma_amo_g2_b32_pmi_example -a -f -e\n"
"      - fma_amo_g2_b32_pmi_example -c\n"
"      - fma_amo_g2_b32_pmi_example -c -C\n"
"      - fma_amo_g2_b32_pmi_example -c -e\n"
"      - fma_amo_g2_b32_pmi_example -c -I\n"
"      - fma_amo_g2_b32_pmi_example -c -f\n"
"      - fma_amo_g2_b32_pmi_example -c -f -C\n"
"      - fma_amo_g2_b32_pmi_example -c -f -e\n"
"      - fma_amo_g2_b32_pmi_example -c -f -I\n"
"      - fma_amo_g2_b32_pmi_example -m\n"
"      - fma_amo_g2_b32_pmi_example -m -C\n"
"      - fma_amo_g2_b32_pmi_example -m -I\n"
"      - fma_amo_g2_b32_pmi_example -m -f\n"
"      - fma_amo_g2_b32_pmi_example -m -f -C\n"
"      - fma_amo_g2_b32_pmi_example -m -f -I\n"
"      - fma_amo_g2_b32_pmi_example -M\n"
"      - fma_amo_g2_b32_pmi_example -M -C\n"
"      - fma_amo_g2_b32_pmi_example -M -I\n"
"      - fma_amo_g2_b32_pmi_example -M -f\n"
"      - fma_amo_g2_b32_pmi_example -M -f -C\n"
"      - fma_amo_g2_b32_pmi_example -M -f -I\n"
"      - fma_amo_g2_b32_pmi_example -o\n"
"      - fma_amo_g2_b32_pmi_example -o -C\n"
"      - fma_amo_g2_b32_pmi_example -o -e\n"
"      - fma_amo_g2_b32_pmi_example -o -f\n"
"      - fma_amo_g2_b32_pmi_example -o -f -C\n"
"      - fma_amo_g2_b32_pmi_example -o -f -e\n"
"      - fma_amo_g2_b32_pmi_example -s\n"
"      - fma_amo_g2_b32_pmi_example -s -C\n"
"      - fma_amo_g2_b32_pmi_example -s -e\n"
"      - fma_amo_g2_b32_pmi_example -s -f\n"
"      - fma_amo_g2_b32_pmi_example -s -f -C\n"
"      - fma_amo_g2_b32_pmi_example -s -f -e\n"
"      - fma_amo_g2_b32_pmi_example -x\n"
"      - fma_amo_g2_b32_pmi_example -x -C\n"
"      - fma_amo_g2_b32_pmi_example -x -e\n"
"      - fma_amo_g2_b32_pmi_example -x -f\n"
"      - fma_amo_g2_b32_pmi_example -x -f -C\n"
"      - fma_amo_g2_b32_pmi_example -x -f -e\n"
"      - fma_amo_g2_b32_pmi_example -X\n"
"      - fma_amo_g2_b32_pmi_example -X -C\n"
"      - fma_amo_g2_b32_pmi_example -X -e\n"
"      - fma_amo_g2_b32_pmi_example -X -f\n"
...
{
    gni_fma_cmd_type_t amo_command = GNI_FMA_ATOMIC2_AND_S;
    ...
    while ((opt = getopt(argc, argv, "ab:cCefhImMn:osvxX")) != -1) {
        switch (opt) {
        case 'a':
            amo_command = GNI_FMA_ATOMIC2_IADD_S;
        ...
        case 'c':
            amo_command = GNI_FMA_ATOMIC2_CSWAP_S;
            transfer_length = 2;
        ...
        case 'I':
            ...
            invalid_compare_value = INVALID_COMPARE_VALUE;
            reverse_min_max_value = REVERSE_MIN_MAX_VALUE;

            break;

        case 'm':
            amo_command = GNI_FMA_ATOMIC2_IMIN_S;

            break;

        case 'M':
            amo_command = GNI_FMA_ATOMIC2_IMAX_S;
        ...
        case 'o':
            amo_command = GNI_FMA_ATOMIC2_OR_S;

            break;

        case 's':
            amo_command = GNI_FMA_ATOMIC2_SWAP_S;
        ...
        case 'x':
            amo_command = GNI_FMA_ATOMIC2_XOR_S;

            break;

        case 'X':
            amo_command = GNI_FMA_ATOMIC2_AX_S;
            transfer_length = 2;
            byte_alignment = BYTE_ALIGNMENT * transfer_length;
    ...
    if (use_fetch == 1) {
        switch (amo_command) {
        case GNI_FMA_ATOMIC2_AND_S:
            amo_command = GNI_FMA_ATOMIC2_FAND_S;
            break;
        case GNI_FMA_ATOMIC2_AX_S:
            amo_command = GNI_FMA_ATOMIC2_FAX_S;
            transfer_length = 1;
            byte_alignment = BYTE_ALIGNMENT;
            break;
        case GNI_FMA_ATOMIC2_CSWAP_S:
            amo_command = GNI_FMA_ATOMIC2_FCSWAP_S;
            transfer_length = 1;
            byte_alignment = BYTE_ALIGNMENT;
            break;
        case GNI_FMA_ATOMIC2_IADD_S:
            amo_command = GNI_FMA_ATOMIC2_FIADD_S;
            break;
        case GNI_FMA_ATOMIC2_IMAX_S:
            amo_command = GNI_FMA_ATOMIC2_FIMAX_S;
            break;
        case GNI_FMA_ATOMIC2_IMIN_S:
            amo_command = GNI_FMA_ATOMIC2_FIMIN_S;
            break;
        case GNI_FMA_ATOMIC2_OR_S:
            amo_command = GNI_FMA_ATOMIC2_FOR_S;
            break;
        case GNI_FMA_ATOMIC2_SWAP_S:
            amo_command = GNI_FMA_ATOMIC2_FSWAP_S;
            break;
        case GNI_FMA_ATOMIC2_XOR_S:
            amo_command = GNI_FMA_ATOMIC2_FXOR_S;
            break;
        default:
            break;
        }
    ...
    if (use_cache_request == 1) {
        ...
        switch (amo_command) {
        case GNI_FMA_ATOMIC2_AND_S:
            amo_command = GNI_FMA_ATOMIC2_AND_SC;
            break;
        case GNI_FMA_ATOMIC2_FAND_S:
            amo_command = GNI_FMA_ATOMIC2_FAND_SC;
            break;
        case GNI_FMA_ATOMIC2_AX_S:
            amo_command = GNI_FMA_ATOMIC2_AX_SC;
            break;
        case GNI_FMA_ATOMIC2_FAX_S:
            amo_command = GNI_FMA_ATOMIC2_FAX_SC;
            break;
        case GNI_FMA_ATOMIC2_CSWAP_S:
            amo_command = GNI_FMA_ATOMIC2_CSWAP_SC;
            break;
        case GNI_FMA_ATOMIC2_FCSWAP_S:
            amo_command = GNI_FMA_ATOMIC2_FCSWAP_SC;
            break;
        case GNI_FMA_ATOMIC2_IADD_S:
            amo_command = GNI_FMA_ATOMIC2_IADD_SC;
            break;
        case GNI_FMA_ATOMIC2_FIADD_S:
            amo_command = GNI_FMA_ATOMIC2_FIADD_SC;
            break;
        case GNI_FMA_ATOMIC2_IMAX_S:
            amo_command = GNI_FMA_ATOMIC2_IMAX_SC;
            break;
        case GNI_FMA_ATOMIC2_FIMAX_S:
            amo_command = GNI_FMA_ATOMIC2_FIMAX_SC;
            break;
        case GNI_FMA_ATOMIC2_IMIN_S:
            amo_command = GNI_FMA_ATOMIC2_IMIN_SC;
            break;
        case GNI_FMA_ATOMIC2_FIMIN_S:
            amo_command = GNI_FMA_ATOMIC2_FIMIN_SC;
            break;
        case GNI_FMA_ATOMIC2_OR_S:
            amo_command = GNI_FMA_ATOMIC2_OR_SC;
            break;
        case GNI_FMA_ATOMIC2_FOR_S:
            amo_command = GNI_FMA_ATOMIC2_FOR_SC;
            break;
        case GNI_FMA_ATOMIC2_SWAP_S:
            amo_command = GNI_FMA_ATOMIC2_SWAP_SC;
            break;
        case GNI_FMA_ATOMIC2_FSWAP_S:
            amo_command = GNI_FMA_ATOMIC2_FSWAP_SC;
            break;
        case GNI_FMA_ATOMIC2_XOR_S:
            amo_command = GNI_FMA_ATOMIC2_XOR_SC;
            break;
        case GNI_FMA_ATOMIC2_FXOR_S:
            amo_command = GNI_FMA_ATOMIC2_FXOR_SC;
            break;
        default:
            break;
        }
    ...
    transfer_length_in_bytes = sizeof(uint32_t) * transfer_length * buffer_size;
    ...
    my_send_to = (uint32_t) send_to << NODE_SHIFT;
    receive_from = (number_of_ranks + rank_id - 1) % number_of_ranks;
    my_receive_from = (uint32_t) receive_from << NODE_SHIFT;
    my_rank = (uint32_t) rank_id << NODE_SHIFT;
     ...
     *            tt is the transfer number
     *            xxxx is one of the following values:
     *            0000 - ALL_ZEROS
     *            1111 - ALL_ONES
     *            5b5b - DEFAULT
     */
    ...
    switch (amo_command) {
    case GNI_FMA_ATOMIC2_AND_S:
    case GNI_FMA_ATOMIC2_AND_SC:
    case GNI_FMA_ATOMIC2_FAND_S:
    case GNI_FMA_ATOMIC2_FAND_SC:
    case GNI_FMA_ATOMIC2_AX_S:
    case GNI_FMA_ATOMIC2_AX_SC:
    case GNI_FMA_ATOMIC2_FAX_S:
    case GNI_FMA_ATOMIC2_FAX_SC:
        source_init_value = (uint32_t) (my_rank | ALL_ONES_DATA);
        target_init_value = (uint32_t) (my_rank | DEFAULT_DATA);
        break;
    case GNI_FMA_ATOMIC2_CSWAP_S:
    case GNI_FMA_ATOMIC2_CSWAP_SC:
    case GNI_FMA_ATOMIC2_FCSWAP_S:
    case GNI_FMA_ATOMIC2_FCSWAP_SC:
    case GNI_FMA_ATOMIC2_OR_S:
    case GNI_FMA_ATOMIC2_OR_SC:
    case GNI_FMA_ATOMIC2_FOR_S:
    case GNI_FMA_ATOMIC2_FOR_SC:
    case GNI_FMA_ATOMIC2_SWAP_S:
    case GNI_FMA_ATOMIC2_SWAP_SC:
    case GNI_FMA_ATOMIC2_FSWAP_S:
    case GNI_FMA_ATOMIC2_FSWAP_SC:
    case GNI_FMA_ATOMIC2_XOR_S:
    case GNI_FMA_ATOMIC2_XOR_SC:
    case GNI_FMA_ATOMIC2_FXOR_S:
    case GNI_FMA_ATOMIC2_FXOR_SC:
        source_init_value = (uint32_t) (my_rank | ALL_ZEROS_DATA);
        target_init_value = (uint32_t) (my_rank | DEFAULT_DATA);
        break;
    case GNI_FMA_ATOMIC2_IADD_S:
    case GNI_FMA_ATOMIC2_IADD_SC:
    case GNI_FMA_ATOMIC2_FIADD_S:
    case GNI_FMA_ATOMIC2_FIADD_SC:
        source_init_value = (uint32_t) (my_rank | ALL_ZEROS_DATA);
        target_init_value = (uint32_t) (my_rank | ALL_ZEROS_DATA);
        break;
    case GNI_FMA_ATOMIC2_IMAX_S:
    case GNI_FMA_ATOMIC2_IMAX_SC:
    case GNI_FMA_ATOMIC2_FIMAX_S:
    case GNI_FMA_ATOMIC2_FIMAX_SC:
    case GNI_FMA_ATOMIC2_IMIN_S:
    case GNI_FMA_ATOMIC2_IMIN_SC:
    case GNI_FMA_ATOMIC2_FIMIN_S:
    case GNI_FMA_ATOMIC2_FIMIN_SC:
        source_init_value = (uint32_t) (my_rank | ALL_ZEROS_DATA |
            reverse_min_max_value);
        target_init_value = (uint32_t) (my_rank | ALL_ZEROS_DATA |
            reverse_min_max_value);
        break;
    default:
    ...
    for (i = 0; i < transfers; i++) {
        if ((amo_command == GNI_FMA_ATOMIC2_CSWAP_S) ||
            (amo_command == GNI_FMA_ATOMIC2_CSWAP_SC) ||
            (amo_command == GNI_FMA_ATOMIC2_FCSWAP_S) ||
            (amo_command == GNI_FMA_ATOMIC2_FCSWAP_SC) ||
            (amo_command == GNI_FMA_ATOMIC2_SWAP_S) ||
            ...
            value = (uint32_t) 1 << shift_count;
        } else {
            value = 0;
        } 

        transfer_count = (uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT;

        for (j = 0; j < (transfer_length * buffer_size); j = j + transfer_length) {
            source_buffer[((i * transfer_length * buffer_size) + j)] =
                source_init_value | transfer_count | value;
            target_buffer[((i * transfer_length * buffer_size) + j)] =
                target_init_value | transfer_count;

            if ((v_option && (j == 0)) || (v_option > 1)) {
                fprintf(stdout,
                        "[%s] Rank: %4i Source data init: transfer: %4i element: %4i"
                        " addr: 0x%lx data value: 0x%08x\n",
                        uts_info.nodename, rank_id,
                        (i + 1), j,
                        &source_buffer[((i * transfer_length * buffer_size) + j)],
                        source_buffer[((i * transfer_length * buffer_size) + j)]);
                ...
                fprintf(stdout,
                        "[%s] Rank: %4i Target data init: transfer: %4i element: %4i"
                        " addr: 0x%lx data value: 0x%08x\n",
                        uts_info.nodename, rank_id,
                        (i + 1), j,
                        &target_buffer[((i * transfer_length * buffer_size) + j)],
    ...
    for (i = 0; i < transfers; i++) {
        ...
        if ((amo_command != GNI_FMA_ATOMIC2_IADD_S) &&
                   (amo_command != GNI_FMA_ATOMIC2_IADD_SC) &&
                   (amo_command != GNI_FMA_ATOMIC2_FIADD_S) &&
                   (amo_command != GNI_FMA_ATOMIC2_FIADD_SC)) {
        ...
        case GNI_FMA_ATOMIC2_FSWAP_S:
        case GNI_FMA_ATOMIC2_FSWAP_SC:
            fma_data_desc[i].first_operand = (my_rank |
                ((uint64_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                ((uint64_t) 1 << ((rank_id * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO));
            break;
        case GNI_FMA_ATOMIC2_XOR_S:
        case GNI_FMA_ATOMIC2_XOR_SC:
        case GNI_FMA_ATOMIC2_FXOR_S:
        ...
        if (v_option) {
            if ((amo_command == GNI_FMA_ATOMIC2_CSWAP_S) ||
                ...
                (amo_command == GNI_FMA_ATOMIC2_FAX_SC)) {
                fprintf(stdout,
                        "[%s] Rank: %4i GNI_PostFma       amo request transfer: %4i amo: 0x%04x sent to:  %4i remote addr: 0x%lx length: %4i operand1: 0x%08x operand2: 0x%08x\n",
                ...
                fprintf(stdout,
                        "[%s] Rank: %4i GNI_PostFma       amo request transfer: %4i amo: 0x%04x sent to:  %4i length: %4i remote addr: 0x%lx operand: 0x%08x\n",
                        uts_info.nodename, rank_id, (i + 1),
                        fma_data_desc[i].amo_cmd, send_to,
    ...
    for (i = 0; i < transfers; i++) {
        ...
        case GNI_FMA_ATOMIC2_FAND_SC:
            expected_data =  my_rank | transfer_count |
                (~((uint32_t) 1 << shift_count) & DATA_MASK);
            break;
        case GNI_FMA_ATOMIC2_CSWAP_S:
        case GNI_FMA_ATOMIC2_CSWAP_SC:
        case GNI_FMA_ATOMIC2_FCSWAP_S:
        case GNI_FMA_ATOMIC2_FCSWAP_SC:
            if (do_invalid_compare == 0) {
                expected_data = (uint32_t) (my_receive_from |
                    ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                    ((uint32_t) 1 << shift_count));
            } else {
                shift_count = ((rank_id * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO;
                expected_data = (uint32_t) (my_rank |
                    ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                    ((uint32_t) 1 << shift_count));
            }
            break;
        ...
        case GNI_FMA_ATOMIC2_IADD_SC:
            if (i == 0) {
                transfer_count = (uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT;
                expected_data =  my_rank | transfer_count |
                    ((uint32_t) (transfers * INTEGER_ADD_VALUE));
            } else {
                expected_data =  my_rank | transfer_count;
           }
            break;
        ...
        case GNI_FMA_ATOMIC2_FIADD_SC:
            if (i == 0) {
                transfer_count = (uint32_t) (transfers + 1) << TRANSFER_COUNT_SHIFT;
                expected_data =  my_rank | transfer_count |
                    ((uint32_t) (transfers * INTEGER_ADD_VALUE));
            } else {
                expected_data =  my_rank | transfer_count;
        ...
        case GNI_FMA_ATOMIC2_FIMIN_SC:
            if (do_invalid_compare == 0) {
                shift_count = ((rank_id * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO;
                expected_data = (my_rank | ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                    ALL_ZEROS_DATA);
            } else {
                shift_count = ((receive_from * RANK_MULTIPLIER) + i) % SHIFT_COUNT_MODULO;
                expected_data = (my_rank | ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
        ...
        for (j = 0; j < (transfer_length * buffer_size); j = j + transfer_length) {
            source_data = source_buffer[j + (i * transfer_length * buffer_size)];
            ...
            if (source_data != expected_data) {
                ...
                fprintf(stdout,
                        ...
                        " addr: 0x%lx data value: 0x%08x, should be: 0x%08x\n",
                        uts_info.nodename, rank_id, (i + 1), j,
                        &source_buffer[j + (i * transfer_length * buffer_size)],
                        source_data,
                        expected_data);
            } else if (v_option) {
                if ((j == 0) || (v_option > 1)) {
    ...
    for (i = 0; i < transfers; i++) {
        ...
        case GNI_FMA_ATOMIC2_AND_S:
        case GNI_FMA_ATOMIC2_AND_SC:
            expected_data = (uint32_t) (my_rank | transfer_count | DEFAULT_DATA);
            break;
        case GNI_FMA_ATOMIC2_FAND_S:
        case GNI_FMA_ATOMIC2_FAND_SC:
        ...
        case GNI_FMA_ATOMIC2_FAX_S:
        case GNI_FMA_ATOMIC2_FAX_SC:
            expected_data = (uint32_t) (my_send_to | transfer_count | ALL_ONES_DATA);
            break;
        case GNI_FMA_ATOMIC2_CSWAP_S:
        case GNI_FMA_ATOMIC2_CSWAP_SC:
            expected_data = (uint32_t) (my_rank |
                ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) | DEFAULT_DATA);
            break;
        case GNI_FMA_ATOMIC2_FCSWAP_S:
        case GNI_FMA_ATOMIC2_FCSWAP_SC:
            expected_data = (uint32_t) (my_send_to |
                ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                ((uint32_t) 1 << shift_count));
            break;
        case GNI_FMA_ATOMIC2_IADD_S:
        case GNI_FMA_ATOMIC2_IADD_SC:
            expected_data = (uint32_t) (my_rank | transfer_count);
            break;
        case GNI_FMA_ATOMIC2_FIADD_S:
        case GNI_FMA_ATOMIC2_FIADD_SC:
            expected_data = (uint32_t) (my_send_to | transfer_count | (i * INTEGER_ADD_VALUE));
            break;
        case GNI_FMA_ATOMIC2_IMAX_S:
        case GNI_FMA_ATOMIC2_IMAX_SC:
            expected_data = (my_rank | ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                ALL_ZEROS_DATA | reverse_min_max_value);
            break;
        case GNI_FMA_ATOMIC2_FIMAX_S:
        case GNI_FMA_ATOMIC2_FIMAX_SC:
            expected_data = (my_send_to | ((uint32_t) (i + 1) << TRANSFER_COUNT_SHIFT) |
                ALL_ZEROS_DATA | reverse_min_max_value);
            break;
        case GNI_FMA_ATOMIC2_IMIN_S:
        case GNI_FMA_ATOMIC2_IMIN_SC:
        ...
        for (j = 0; j < (transfer_length * buffer_size); j = j + transfer_length) {
            target_data = target_buffer[j + (i * transfer_length * buffer_size)];
            ...
            if (target_data != expected_data) {
                ...
                fprintf(stdout,
                        ...
                        " addr: 0x%lx data value: 0x%08x, should be: 0x%08x\n",
                        uts_info.nodename, rank_id, (i + 1), j,
                        &target_buffer[j + (i * transfer_length * buffer_size)],
                        target_data,
                        expected_data);
            } else if (v_option) {
                if ((j == 0) || (v_option > 1)) {
